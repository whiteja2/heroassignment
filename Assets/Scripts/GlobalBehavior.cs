...
public class GlobalBehavior : MonoBehaviour {
    ...
    #region EggCount support
    public Text mEggCountEcho = null;  // Defined in UnityEngine.UI
    private int mEggCount = 0;
    #endregion
	#region Touched support
    public Text mTouchedEcho = null;  // Defined in UnityEngine.UI
    private int mTouched = 0;
    #endregion
	#region ControlMode support
    public Text mControlModeEcho = null;  // Defined in UnityEngine.UI
	private bool mControlMode = false;
    #endregion
	#region EnemyInfo support
    public Text mEnemyInfoEcho = null;  // Defined in UnityEngine.UI
	private int mDestroyed = 0;
    #endregion
    ...
    void Start () {
		...
		Debug.Assert(mTouchedEcho != null);  // make sure this is set up
    ...
    #region EggCount support
    public void IncEggCount() { mEggCount++; EchoEggCount(); }
    public void DecEggCount() { mEggCount--; if (mEggCount < 0) mEggCount = 0; EchoEggCount();  }
    private void EchoEggCount()
    {
        mEggCountEcho.text = "Egg Count: " + mEggCount;
    }
    #endregion
	#region Touched support
    public void IncTouched() { mTouched++; EchoTouched(); }
    private void EchoTouched()
    {
		mTouchedEcho.text = "Touched: " + mTouched;
    }
    #endregion
	#region ControlMode support
    public void ChangeCM() 
	{
		mControlMode = !mControlMode;
		EchoControlMode();  
	}
    private void EchoControlMode()
    {
		if (mControlMode)
		{
			mControlModeEcho.text = "Hero: Control Mode: Keyboard";
		}
        else
		{
			mControlModeEcho.text = "Hero: Control Mode: Mouse";
		}
    }
    #endregion
	#region EnemyInfo support
    ...
    private void EchoEnemyInfo()
    {
		mEnemyInfoEcho.text = "Enemy: Count: 10 Destroyed: " + mDestroyed;
    }
    #endregion
}
